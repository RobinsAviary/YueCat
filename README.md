...
YueCat is a software development framework, largely focused on making games. It allows you to create software entirely without an editor using a flavor of Lua called [YueScript](https://github.com/IppClub/YueScript).
