...
vertex_registry := Registry {
	"Vertex",
	{
		...
		{VertexSetClipPlanes, "SetClipPlanes"},
		{VertexSetClipPlaneNear, "SetClipPlaneNear"},
		{VertexSetClipPlaneFar, "SetClipPlaneFar"},
		{VertexGetClipPlaneNear, "GetClipPlaneNear"},
		{VertexGetClipPlaneFar, "GetClipPlaneFar"},
		{VertexEnableWireMode, "EnableWireMode"},
		{VertexEnablePointMode, "EnablePointMode"},
		{VertexDisableWirePointMode, "DisableWirePointMode"},
		{VertexSetCullMode, "SetCullMode"},
		{VertexSetLineThickness, "SetLineThickness"},
		{VertexGetLineThickness, "GetLineThickness"},
		{VertexDisableBackfaceCulling, "DisableBackfaceCulling"},
		{VertexEnableBackfaceCulling, "EnableBackfaceCulling"},
		{VertexSetBackfaceCulling, "SetBackfaceCulling"},
		{VertexVersion, "Version"},
	},
}
